...
public class WeatherSearchActivity extends AppCompatActivity {
    ...
    private void initMapView(){
        mMapView = findViewById(R.id.weather_bmapView);
        mBaiduMap = mMapView.getMap();
        final LatLng center = new LatLng(targetAddress.getLatitude(), targetAddress.getLongitude());
        ...
        btnSearchAddress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WeatherSearchActivity.this,SearchActivity.class);
    ...
    private void popupWeatherDialog(WeatherResult weatherResult){
        ...
        String relativeHumidity = "相对湿度：" + weatherSearchRealTime.getRelativeHumidity() + "%";
